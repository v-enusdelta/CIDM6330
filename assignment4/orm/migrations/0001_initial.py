    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sessionid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orm.session')),
            ],
        ),
        migrations.AddField(
            model_name='session',
            name='userid',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orm.user'),
        ),
    ]
